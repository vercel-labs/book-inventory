		...
		return (
			<div className="max-w-md p-6 mx-auto bg-white border border-gray-200 rounded-lg shadow-md">
				...
				<p className="text-gray-700">
					...
					<code className="p-1 font-mono text-red-600 bg-gray-200 rounded">books</code> table.
					Please run the script{' '}
					<code className="p-1 font-mono text-green-600 bg-gray-200 rounded">npm run seed</code> to
